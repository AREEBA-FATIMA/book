...
const config: Config = {
  ...
  url: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://book-mu-ebon.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://huggingface.co/spaces/areeba-fatima/book/tree/main/frontend/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://huggingface.co/spaces/areeba-fatima/book',
          label: 'GitHub',
          position: 'right',
        },
      ],
          ...
          items: [
            {
              ...
              href: 'https://huggingface.co/spaces/areeba-fatima/book/discussions',
            },
            {
              label: 'Issues',
              href: 'https://huggingface.co/spaces/areeba-fatima/book/discussions',
